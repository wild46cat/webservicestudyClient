 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://xueyou.xueyoucto.com/", wsdlLocation = "http://localhost:8888/HelloService/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://xueyou.xueyoucto.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/HelloService/?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://xueyou.xueyoucto.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://xueyou.xueyoucto.com/", "HelloServicePort"), HelloService.class, features);
    }
